...
def upgrade() -> None:
    ...
    op.create_table('contrato',
        ...
        sa.Column('id_decreto_origen', sa.Integer(), nullable=True, comment='Referencia al decreto si el contrato nació de una renovación por decreto'),
        ...
        sa.ForeignKeyConstraint(['id_decreto_origen'], ['rrhh.decreto_incremento_salarial.id'], name=op.f('fk_contrato_id_decreto_origen_decreto_incremento_salarial'), ondelete='SET NULL'),
